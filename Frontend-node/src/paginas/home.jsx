...
export function Home() {
  ...
  return (
    <main>
      <form className='row form-ingreso'>
        <div className='col-12 col-lg-1' />
        <div className='col-12 col-lg-5' style={{ alignItems: 'center' }}>
          <p>
            Ingrese su documento: <input type='text' id='nombre' />
          </p>
        </div>
        <div className='col-12 col-lg-5'>
          <p>
            Ingrese su clave: <input type='password' id='clave' />
          </p>
        </div>
        <div className='col-12 col-lg-1'>
