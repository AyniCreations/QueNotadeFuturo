...
export function Album() {
  return (
    <div className="containerFotos col-12">
      ...
      <br/>
      <h3>
          "La música da alma al universo, alas a la mente, vuelos a la imaginación,<br/>
      ...
      <div className="imagen">
        ...
        <img
          src={BiblioMompoxImg}
          alt='bibliobarriomompox'
        />
        <br/>
        <br/>
        <br/>
        <p>IMAGEN: Campaña "Haz parte de la banda sonora de sus vidas" - Cundinamarca</p>
        <img
          src={CampañaCund_ElTiempoImg}
          alt='CampañaCund_ElTiempo'
        />
        <br/>
        <br/>
        <br/>
        ...
        <img
          src={ParcheExtremoTunjaImg}
          alt='ParcheExtremoTunja'
        />
      </div>
    </div>
  )
